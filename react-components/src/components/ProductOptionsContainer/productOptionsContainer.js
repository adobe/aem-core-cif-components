...
const ProductOptionsContainer = () => {
    ...
    const {
        mountingPoints: { productOptionsContainer }
    } = useConfigContext();
    ...
    const canAddToCart = () => {
        let result =
            optionsUtils.isOptionsStateValid(bundleState) && optionsUtils.isOptionsStateValid(customizableOptionsState);
        return result;
    };
    ...
    if (showCustomizeButton) {
        return (
            <section className="productFullDetail__section productFullDetail__customizeBundle">
                <Button
                    priority="high"
                    onClick={() => setOptionsState({ ...optionsState, showCustomizeButton: false })}>
        ...
        <>
            {bundleState !== null && (
                <BundleProductOptions
                    ...
                    data={bundleState}
                    handleBundleChange={newBundleState =>
                        setOptionsState({ ...optionsState, bundleState: newBundleState })
                    }
                />
            )}
            {customizableOptionsState !== null && (
                <CustomizableProductOptions
                    ...
                    handleOptionsChange={newCustomizableOptionsState =>
                        setOptionsState({ ...optionsState, customizableOptionsState: newCustomizableOptionsState })
                    }
                />
            )}
