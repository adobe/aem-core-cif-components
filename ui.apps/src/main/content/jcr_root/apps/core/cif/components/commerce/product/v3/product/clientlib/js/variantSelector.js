...
class VariantSelector {
    constructor(config) {
        ...
        this._state.useUid = this._product.hasAttribute('data-uid-cart');
...
(function(document) {
    function onDocumentReady() {
        ...
        const productCmp = document.querySelector(VariantSelector.selectors.product);
        if (variantSelectorCmp) new VariantSelector({ element: variantSelectorCmp, product: productCmp });
    }
