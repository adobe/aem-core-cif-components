...
class SearchResults {
    ...
    _updatePrices() {
        this._element.querySelectorAll(SearchResults.selectors.item).forEach(item => {
            ...
            item.querySelector(SearchResults.selectors.price).innerHTML = innerHTML;
        });
    }
}

SearchResults.selectors = {
    self: '[data-cmp-is=searchresults]',
    price: '.price',
...
(function(document) {
    function onDocumentReady() {
        ...
        const searchResultsCmp = document.querySelector(ProductList.selectors.self);
        if (searchResultsCmp) new ProductList({ element: searchResultsCmp });
    }
