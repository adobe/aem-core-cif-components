...
public class CommerceRedirectServletTest {
    private CommerceRedirectServlet servlet;
    ...
    @Before
    public void setUp() {
        servlet = new CommerceRedirectServlet();
    ...
    @Test
    public void testMissingSuffix() throws IOException {
