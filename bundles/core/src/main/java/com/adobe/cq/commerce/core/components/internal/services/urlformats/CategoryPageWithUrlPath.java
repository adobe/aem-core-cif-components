...
public class CategoryPageWithUrlPath extends UrlFormatBase implements CategoryPageUrlFormat {
    public static final CategoryPageUrlFormat INSTANCE = new CategoryPageWithUrlPath();
