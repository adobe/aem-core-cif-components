...
import com.adobe.cq.commerce.core.components.models.GraphqlUsePojo;
...
public class ProductTeaserUse extends GraphqlUsePojo {
    ...
    public void activate() throws Exception {
        super.activate();
        String selection = getProperties().get(SELECTION_PROPERTY, String.class);
        ...
        vars.put("selection", sku);
        Query rootQuery = executeQuery(vars);
        if (rootQuery == null) {
            return;
        }
