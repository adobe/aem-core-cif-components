...
import com.adobe.cq.commerce.core.components.internal.services.urlformats.CategoryPageWithUID;
    ...
    public static final Map<String, CategoryUrlFormat> DEFAULT_CATEGORY_URL_FORMATS = new HashMap<String, CategoryUrlFormat>() {
        {
            ...
            put(CategoryPageWithUID.PATTERN, CategoryPageWithUID.INSTANCE);
        }
    };
