...
public class ProductPageWithSku extends UrlFormatBase implements ProductPageUrlFormat {
    public static final ProductPageUrlFormat INSTANCE = new ProductPageWithSku();
