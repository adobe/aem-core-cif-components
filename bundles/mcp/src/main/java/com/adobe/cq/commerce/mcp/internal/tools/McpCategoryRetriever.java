 ...
 * GraphQL query is trimmed to the fields required by the tool's response DTO: uid, name, url_path and the same
 * fields for the immediate children.
 */
