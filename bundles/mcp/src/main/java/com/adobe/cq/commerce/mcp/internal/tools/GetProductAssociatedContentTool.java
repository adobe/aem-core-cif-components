...
/**
 * MCP tool listing AEM content associated with a product SKU: experience fragments, content fragments,
 * associated content pages, and DAM assets referenced from matched content fragments.
 */
@Component(service = McpTool.class)
public class GetProductAssociatedContentTool implements McpTool {
    ...
    @Override
    public String name() {
        return "get_product_associated_content";
    }

    @Override
    public String description() {
        return "List AEM experience fragments, content fragments, associated pages, and DAM assets linked to a product SKU.";
    }
    ...
    public JsonNode call(McpCallContext context, JsonNode args) {
        ...
        return AssociatedContentSupport.buildProductResult(associatedContentService, mapper,
            ctx.getRequest().getResourceResolver(), ctx.getLandingPage(), sku,
