...
describe('Checkbox Uncheck Test', () => {
    ...
    it('can enable/disable JSON-LD, save changes, and verify JSON-LD on the product page', async () => {
        ...
        await enableJsonLdCheckbox.waitForDisplayed({ timeout: 20000 });
        ...
        await saveButton.waitForDisplayed({ timeout: 20000 });
        ...
        await browser.waitUntil(
            ...
            { timeout: 20000, timeoutMsg: 'Product page did not load in time' }
        );
